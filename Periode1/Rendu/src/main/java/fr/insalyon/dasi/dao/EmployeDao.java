...
public class EmployeDao {
    ...
    public Employe chercherParGenre(String genre) {
        EntityManager em = JpaUtil.obtenirContextePersistance();
        TypedQuery<Employe> query = em.createQuery("SELECT e FROM Employe e WHERE e.genre = :genre AND e.disponible=true ORDER BY e.nbConsultations ASC", Employe.class);
